...
var wxAccount = {
    //添加
    addAccount: function (keyid,data, cb) {
        for(var i=0;i<data.length;i++){
            connection.query('insert into wx_account set ?', {wxkeyid:keyid}, function (err, result) {
...
exports.collectManager = collectManager;